      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 md:gap-24">
        ...
        >
          <p className="font-sans text-base md:text-lg text-muted-foreground leading-relaxed mb-6">
            This journal is a quiet space for the analog images I make while wandering. I shoot
            exclusively on film -- mostly 35mm and medium format -- drawn to the unpredictability,
            the grain, and the physical weight of each exposure.
          </p>
          <p className="font-sans text-base md:text-lg text-muted-foreground leading-relaxed mb-6">
            Every photograph here was developed by hand and scanned from the negative. No digital
            manipulation, no filters. Just chemistry, light, and whatever truth the emulsion chooses
            to hold.
          </p>
